...
export default function MaximumBorrowingAmount() {
    ...
    return (
        <div className="accordion-maximum-borrowing-amount" onClick={() => toggleActive()}>
            <div className="accordion-item-maximum-borrowing-amount" >Maximum Borrowing Amount <div>{isActive ? '-' : '+'}</div></div>

            {isActive &&
                <div id='maximum-borrowing-amount'>
                    <h2>Maximum Borrowing Calculator</h2>
